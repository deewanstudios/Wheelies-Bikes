<?php
	/*
	 ...
	 This PHP class uses the PHP Webservice of http://www.geoplugin.com/ to geolocate
	 IP addresses

	 Geographical location of the IP address (visitor) and locate currency (symbol,
	 code and exchange rate) are returned.

	 See http://www.geoplugin.com/webservices/php for more specific details of this
	 free service
	...
	class geoPlugin
	{
		...
		function convert  (  $amount  ,  $float  =  2  ,  $symbol  =  true  )
		{
			...
			if  (  $symbol  ===  true  )
			{
				...
				// return $this->currencySymbol . round( number_format($amount *
