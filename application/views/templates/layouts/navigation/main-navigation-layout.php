<?php
	...
	$this  ->  m_navigation  .=  "<nav class=\"rd-navbar rd-navbar-default rd-navbar-light\"";
	$this  ->  m_navigation  .=  "data-md-device-layout=\"rd-navbar-fixed\" data-lg-device-layout=\"rd-navbar-static\"";
	...
	$this  ->  m_navigation  .=  "<button class=\"rd-navbar-toggle\" data-rd-navbar-toggle=\".rd-navbar, .rd-navbar-nav-wrap\">";
	$this  ->  m_navigation  .=  "<span></span>";
	...
	$this  ->  m_navigation  .=  "<img style=\"margin-top: -5px;margin-left: -15px;\" width=\"130\" height=\"31\" src=\"{$this->m_image_directory}logo/trophme-logo-grey.png\" alt=\"\"/>";
	$this  ->  m_navigation  .=  "</a>";
