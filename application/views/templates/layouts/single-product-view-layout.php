...
$this->m_content_builder .= "</div>";
$this->m_content_builder .= "<!-- Product Add To cart--><a class=\"btn btn-sm btn-primary btn-icon btn-icon-left product-btn offset-top-20 offset-xs-top-0 btn-view-product\" href=\"\"><span class=\"icon mdi mdi-cart-outline\"></span>Add to Cart</a>";
$this->m_content_builder .= "</div>";
